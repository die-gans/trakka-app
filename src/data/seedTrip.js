...
export const INITIAL_ITINERARY_ITEMS = [
  { id: 'item-1', trip_id: 'trip-jervis-bay-2026', title: 'Depart Sydney', day_id: 'thu', row_id: 'transport', start_slot: 6, span: 1, color: 'info', family_ids: ['sydney-crew'], linked_entities: [{ type: 'route', id: 'route-syd-jervis' }] },
  { id: 'item-2', trip_id: 'trip-jervis-bay-2026', title: 'Depart Melbourne', day_id: 'thu', row_id: 'transport', start_slot: 0, span: 2, color: 'warning', family_ids: ['melbourne-crew'], linked_entities: [{ type: 'route', id: 'route-mel-jervis' }] },
  { id: 'item-3', trip_id: 'trip-jervis-bay-2026', title: 'Depart Canberra', day_id: 'thu', row_id: 'transport', start_slot: 12, span: 1, color: 'success', family_ids: ['canberra-crew'], linked_entities: [{ type: 'route', id: 'route-cbr-jervis' }, { type: 'task', id: 'task-permits' }] },
  { id: 'item-4', trip_id: 'trip-jervis-bay-2026', title: 'Basecamp Setup', day_id: 'thu', row_id: 'ops', start_slot: 18, span: 1, color: 'info', family_ids: ['sydney-crew', 'melbourne-crew', 'canberra-crew'], linked_entities: [{ type: 'location', id: 'jervis-base' }, { type: 'task', id: 'task-eskies' }] },
  { id: 'item-5', trip_id: 'trip-jervis-bay-2026', title: 'Hyams Beach Swim', day_id: 'fri', row_id: 'activity', start_slot: 12, span: 1, color: 'success', family_ids: ['sydney-crew', 'melbourne-crew', 'canberra-crew'], linked_entities: [{ type: 'location', id: 'hyams-beach' }, { type: 'meal', id: 'fri-lunch' }] },
  { id: 'item-6', trip_id: 'trip-jervis-bay-2026', title: 'Huskisson Pub', day_id: 'fri', row_id: 'food', start_slot: 18, span: 1, color: 'warning', family_ids: ['sydney-crew', 'melbourne-crew', 'canberra-crew'], linked_entities: [{ type: 'location', id: 'huskisson-pub' }, { type: 'expense', id: 'exp-pub' }] },
  { id: 'item-7', trip_id: 'trip-jervis-bay-2026', title: 'Booderee Run', day_id: 'sat', row_id: 'activity', start_slot: 6, span: 2, color: 'critical', family_ids: ['sydney-crew', 'melbourne-crew', 'canberra-crew'], linked_entities: [{ type: 'location', id: 'booderee-park' }, { type: 'meal', id: 'sat-lunch' }, { type: 'task', id: 'task-permits' }] },
]
